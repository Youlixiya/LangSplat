...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=1 python train.py --source_path data/messy_rooms/large_corridor_25 -m output/large_corridor_25 --start_checkpoint data/messy_rooms/large_corridor_25/output/large_corridor_25/chkpnt30000.pth --feature_level ${level}
