...
def render_set(model_path, source_path, name, iteration, views, gaussians_1, gaussians_2, gaussians_3, pipeline, background, args, clip_model, ae_model):
    ...
    if args.dataset_name == 'large_corridor_25':
        # prompt_dict = {"green pot":"which is an object used for planting",
        #             "white plush doll": "what is a white animal doll",
        #             "white bottle": "which is bottle shaped",
        #             "brown bowl": "which is a brown object that can be used for eating", 
        #             "blue lunch box":"which is box with fruit patterns printed on it"}
        prompt_dict = {"green pot":"which is an object used for planting",
    ...
    elif args.dataset_name == 'large_corridor_50':
        prompt_dict = {"black and white shoe":"which is a black and white object that can be worn on the feet",
                    ...
                    "colorful clock":"which is a colorful object used for telling time"}  
    elif args.dataset_name == 'large_corridor_100':
