...
CUDA_VISIBLE_DEVICES=3 python train.py --source_path data/ovs3d/room --images images_4 --model_path data/ovs3d/room/output/room
...
CUDA_VISIBLE_DEVICES=3 python preprocess.py --dataset_path data/ovs3d/room --images images_4
...
CUDA_VISIBLE_DEVICES=3 python train.py --dataset_path data/ovs3d/room --encoder_dims 256 128 64 32 3 --decoder_dims 16 32 64 128 256 256 512 --lr 0.0007 --dataset_name room
...
CUDA_VISIBLE_DEVICES=3  python test.py --dataset_path data/ovs3d/room --dataset_name room
...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=3 python train.py --source_path data/ovs3d/room -m output/room --images images_4 --start_checkpoint data/ovs3d/room/output/room/chkpnt30000.pth --feature_level ${level}
done
# e.g. python train.py -s data/sofa -m output/sofa --start_checkpoint data/sofa/sofa/chkpnt30000.pth --feature_level 3
