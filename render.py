...
def render_set(model_path, source_path, name, iteration, views, gaussians_1, gaussians_2, gaussians_3, pipeline, background, args, clip_model, ae_model):
    ...
    if args.dataset_name == 'figurines':
        prompt_dict = {"green apple":"which is a green fruit rich in vitamins","green toy chair":"which is a small chair for dolls","old camera":"which is a device used for taking pictures","porcelain hand":"which is a decorative object made of porcelain","red apple":"which is a red fruit rich in vitamins","red toy chair":"which is a small chair for dolls","rubber duck with red hat":"which is a bath toy with a red hat"}
        ...
        prompt_dict = {"chopsticks":"which are used for eating Asian cuisine","egg":"which is the round food item with a hard shell that is often boiled and served in a bowl","glass of water":"which is the clear liquid container that is often served alongside a meal","pork belly":"which is the type of meat that is often served in a bowl with noodles and broth","wavy noodles in bowl":"which are the long, thin, and wavy food items that are often served in a bowl with broth and meat","yellow bowl":"which is the container that is often used to serve a hot and savory dish"}
