...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=1 python train.py --include_feature --source_path data/NeRF-DS/as_novel_view -m output/as_novel_view --start_checkpoint data/NeRF-DS/as_novel_view/output/as_novel_view/chkpnt30000.pth --feature_level ${level}
done
...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=2 python train.py --include_feature --source_path data/NeRF-DS/basin_novel_view -m output/basin_novel_view --start_checkpoint data/NeRF-DS/basin_novel_view/output/basin_novel_view/chkpnt30000.pth --feature_level ${level}
done
...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=3 python train.py --include_feature --source_path data/NeRF-DS/cup_novel_view -m output/cup_novel_view --start_checkpoint data/NeRF-DS/cup_novel_view/output/cup_novel_view/chkpnt30000.pth --feature_level ${level}
done
...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=4 python train.py --include_feature --source_path data/NeRF-DS/bell_novel_view -m output/bell_novel_view --start_checkpoint data/NeRF-DS/bell_novel_view/output/bell_novel_view/chkpnt30000.pth --feature_level ${level}
done
...
for level in 1 2 3
do
    CUDA_VISIBLE_DEVICES=5 python train.py --include_feature --source_path data/NeRF-DS/sieve_novel_view -m output/sieve_novel_view --start_checkpoint data/NeRF-DS/sieve_novel_view/output/sieve_novel_view/chkpnt30000.pth --feature_level ${level}
done